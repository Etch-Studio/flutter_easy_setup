...
class AndroidDeployer with DeploySteps {
  ...
  Future<void> _supply(String resolvedTrack, String jsonKeyPath) => step(
        ...
        [
          ...
          '--json_key',
          jsonKeyPath,
          // Store metadata/assets are the M5 screenshot pipeline's job.
          // skip_upload_metadata does NOT cover changelogs — skip explicitly.
